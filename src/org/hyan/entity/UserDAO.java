...
public class UserDAO extends HibernateDaoSupport {
	...
	public List<User> findByStreetAddr(Object streetAddr) {
		return findByProperty(STREET_ADDR, streetAddr);
	}

	public List<User> findByZip(Object zip) {
